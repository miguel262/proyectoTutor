    ...
    pasos: [
        {
            ...
            soluciones:[{entrada:["1","8","12"],pasoSiguiente:"1"}],
        ...
        },
        {
            ...
            soluciones:[{entrada:"16",pasoSiguiente:"2"}],
        ...
        },
        {
            ...
            soluciones:[{entrada:"1",pasoSiguiente:"3"}],
        ...
        },
        {
            ...
            paso: "Paso 4: Calcular los valores de x1 y x2",
            ...
            soluciones:[{entrada:["-2","-6"],pasoSiguiente:"4"}],
